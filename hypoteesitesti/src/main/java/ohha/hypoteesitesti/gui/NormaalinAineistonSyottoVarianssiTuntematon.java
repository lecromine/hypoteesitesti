...
public class NormaalinAineistonSyottoVarianssiTuntematon extends javax.swing.JFrame {

    public NormaalinAineistonSyottoVarianssiTuntematon() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NormaalinAineistonSyottoVarianssiTuntematon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
//        System.out.println("[" + alaraja + ", " + ylaraja + "]");
        ...
        if (p_arvo < 0.1) {
            if (p_arvo < 0.05) {
                if (p_arvo < 0.01) {
                    System.out.println("Todennäköisyys saada oheinen aineisto nollahypoteesin pätiessä on " + df.format(p_arvo) + ".");
            ...
            System.out.println("Todennäköisyys saada saatu aineisto nollahypoteesin pätiessä on " + df.format(p_arvo) + ".");
